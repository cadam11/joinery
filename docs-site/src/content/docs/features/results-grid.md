...
| Copy format `tsv` default, plus `csv` and `json`; headers ignored for json                  | `packages/shared/src/types/settings.types.ts:26-41, 77-78`, `features/query/results-clipboard.ts:97-107`                                              |
...
| Its value is bound, not written into the SQL                                                | `packages/main/src/services/sql/fk-record.ts:64-91`, `services/sql/dialect/sql-dialect.ts:89-101`                                                     |
