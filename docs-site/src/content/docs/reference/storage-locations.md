...
| The folder is `Joinery`, from `productName` in the packaged app's manifest                               | `package.json:3`, `packages/main/src/services/config/user-data-dir.ts:23`                                                                           |
| The lowercase folder is migrated once, and is a no-op where the two names are one directory              | `packages/main/src/services/config/user-data-dir.ts:63-91`, `packages/main/src/index.ts:33-57`                                                      |
