...
| _SQL conversion could not import `<package>`, even though it looked installed._                   | The package is present but broken — a half-installed wheel. The message names it and gives the reinstall command        |
