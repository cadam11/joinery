...
| Claim                                                                                        | Source                                                                                                                                                                                                                      |
| -------------------------------------------------------------------------------------------- | --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| Region layout: titlebar, sidebar, workspace, chat panel, status bar                          | `packages/renderer/src/shell/app-shell.tsx:206-260`                                                                                                                                                                         |
...
| ⌘\ toggles the sidebar; the divider is draggable and the width persists                      | `packages/renderer/src/commands/catalogue.ts:525-530`, `packages/renderer/src/shell/app-shell.tsx:223-232`                                                                                                                  |
| The workspace is Dockview; tabs split and stack; the arrangement is persisted                | `packages/renderer/src/shell/workspace/workspace.tsx:2-37, 122-140`, `packages/renderer/src/persistence/layout.ts:99-135`                                                                                                                                                         |
...
| The assistant: ⇧⌘I, status-bar sparkle, sidebar toggle, persisted width, and the tab variant | `packages/renderer/src/commands/catalogue.ts:533-547`, `packages/renderer/src/shell/status-bar.tsx:395-408`, `packages/renderer/src/shell/sidebar/sidebar.tsx:216-227`, `packages/renderer/src/shell/app-shell.tsx:238-256` |
